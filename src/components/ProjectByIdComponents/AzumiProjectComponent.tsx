...
import azumiJPG from '../../assets/images/portolfio/azumi.jpg';


export const AzumiProjectComponent = () => {
  return (
    <>
      <Helmet>
        <title>Azumi - Jhorman Nieto P</title>
        <link rel="canonical" href={"https://jhorman.com/projects/3"} />
      ...
      <section className="project" id="porking">
        <div className="project-content">
          <div className="project-left">
            <Link className="project-link-image" to={"https://azumipty.com/"}>
              <img src={azumiJPG} className="project-image" alt="Proyecto de porking" />
            </Link>
          </div>
